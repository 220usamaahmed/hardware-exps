...
class ImitationControl(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("max_joint_speed", 0.7)
        ...
        check_point=torch.load('/home/siddiquieu1/ur3e-trajectories/pick2/weights_processed_without_data_augmentation/flow_matching_real_world_data_pick2_processed_without_data_augmentation_epoch_1500.pt', map_location=self.device)
